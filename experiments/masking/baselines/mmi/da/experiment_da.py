...
from optimised_data_loader import create_tf_dataset
...
class MaskingExperimentDA:
    ...
    def step1_train_base_model(self):
        ...
        Reduced batch size and aggressive cleanup.
        """
        print("\n" + "=" * 70)
    ...
    def evaluate_masked(self, model, test_files, mean, std, masking_percentage, num_blocks):
        ...
        Process files one at a time, accumulate metrics incrementally.
    ...
    def step2_evaluate_all_variants(self, test_files, mean, std):
        ...
        Reload model periodically to clear memory.
        """
        print("\n" + "=" * 70)
