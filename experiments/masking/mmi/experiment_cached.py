...
from backbones import SpectrogramResNet, LightweightSpectrogramResNet  # UPDATED: Changed from LightweightSpectrogramResNet
...
def main():
    ...
    config = {
        ...
        'experiment_dir': '/app/data/experiments/masking_newparams_lightweight',
        ...
        'use_cosine_classifier': True, #True,
        'cosine_scale': 40.0, #40.0,
