...
def pre_trainer(scen, fet, base_dir="/app/data/experiments/scaling/baselines"):
    ...
    BATCH_SIZE = 40
    origin = False
    EPOCHS = 30  # Paper: train up to 30 epochs
    path = "/app/data/1.0.0"
    ...
    # Paper: For MMI dataset use Random Scaling, Magnitude Warping, Time Warping, Negation
    def aug1_numpy(x):
    ...
    # Paper: Initial learning rate 0.00003 for pre-training with exponential decay
    ...
    # Paper: Adam optimizer with L2 regularization λ=0.01 (already in layers)
