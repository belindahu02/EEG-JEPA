...
class AugmentedDataSequence(tf.keras.utils.Sequence):
    """Keras Sequence for on-the-fly data augmentation - FIXED FOR SINGLE INPUT"""
...
def pre_trainer(scen):
    ...
    # Extract trunk (not the whole model!)
    fet_extrct = trunk_model
