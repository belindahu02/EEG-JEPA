...
AGGRESSIVE WINDOWING MODE (default):
- 20 second frames with 18 second overlap (90% overlap)
- This means only 2 second stride between frames
- Generates ~10x more training samples compared to 50% overlap
- Still meaningful: all data is real, just different temporal views
...
Example:
    # Default: 90% overlap (very aggressive)
    ...
    # Conservative overlap (original setting)
