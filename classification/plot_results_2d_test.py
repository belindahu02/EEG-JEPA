...
from trainers_2d_test import spectrogram_trainer_2d  # Updated import for 2D trainer
import numpy as np
...
# Configuration
#OUTPUT_PATH = "/app/data/masked_subset10_outputs_large/graph_data_masked_subset10"
#GRAPH_PATH = "/app/data/masked_subset10_outputs_large/graph_2d_masked_subset10"
#CHECKPOINT_PATH = "/app/data/masked_subset10_outputs_large/graph_checkpoints_masked_subset10"
#MODEL_PATH = "/app/data/masked_subset10_outputs_large/model_checkpoints_masked_subset10"
...
TEST_DATA_PATH = "/app/data/grouped_embeddings_masked_subset10_frame_large"  # masked
...
USER_IDS = list(range(1, 21))  # Increased to more users for better evaluation
