...
embeddings_root = "/app/data/data/embeddings_musicid_unstructured"   # root of per-frame embeddings
output_root = "/app/data/data/grouped_embeddings_musicid_unstructured"              # where to save stacked embeddings
