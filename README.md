...
**Requirements:**
- Data inputs must be in **spectrogram** format
...
- [ablation/](https://github.com/belindahu02/EEG-JEPA/tree/main/experiments/scaling/ablation) contains ablation and overfitting experiments
